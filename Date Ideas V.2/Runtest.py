...
def delete():									#Function that will eventually delete an idea on a buttonclick
	print (str(chosen))						#Currently not set up, just a placeholder
...
text.insert('1.0','inserted text')

window.mainloop()									#Loops the GUI window, if the GUI isn't working, check that this is still here window.mainloop()